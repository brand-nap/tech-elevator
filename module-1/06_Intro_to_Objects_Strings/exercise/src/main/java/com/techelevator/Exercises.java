...
public class Exercises {
	...
	public String twoChar(String str, int n) {
		return (n>str.length()-2 || n<0) ? str.substring(0,2) : str.substring(n, n+2);
	}
	...
	public boolean hasBad(String str) {
		return !((!str.contains("bad") ||str.indexOf("bad") >1));
	}
	...
	public String frontTimes(String str, int n) {
		return (str.length()>2) ? stringTimes(str.substring(0,3), n) : stringTimes(str, n);
	}
	...
	public boolean doubleX(String str) {
		return str.contains("xx") ? str.substring(str.indexOf("x")).indexOf("xx") == 0 : false;
	}
	...
	public int last2(String str) {
		int counter = 0;
		if(str.length()>2) {
			String newXX = str.substring(str.length() - 2);
			while (str.contains(newXX) && str.length() > 2) {
				str = str.substring(str.indexOf(newXX.charAt(0)));
				counter += str.indexOf(newXX) == 0 && str.length() > 2 ? 1 : 0;
				str = str.substring(str.indexOf(newXX.charAt(0)) + 1);
			}
		}
		return counter;
	}
	...
	public String stringX(String str) {
		if(str.length() >=1) {
			boolean front = (str.charAt(0) == 'x' && str.length() > 1);
	...
	public String altPairs(String str) {
		String finalStr = "";
		for(int i = 0; i < str.length(); i++){
			finalStr = (i%4<2) ? finalStr + str.charAt(i) : finalStr;
		}
		return finalStr;
	}
