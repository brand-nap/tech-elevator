...
The first row in each column should contain a search that allows you to filter the data in that column. To do this, create a data property called `search` that is an object with the following properties:
