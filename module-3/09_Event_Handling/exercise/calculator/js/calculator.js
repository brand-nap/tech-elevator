...
document.addEventListener('DOMContentLoaded', () => {
  ...
  digits.forEach((dig) => {
    dig.addEventListener('click', (event) => {clickNumber(event)})
  });
  ...
  // as you would for a numberconst digits = document.querySelectorAll('.number')
  const dec = document.querySelector('.decimal')
  dec.addEventListener('click', (event) => {clickNumber(event)})
